...
class GroupsCategory(BaseCategory):
    ...
    async def get_catalog_info(
		...
		**kwargs
        ...
        model = groups.GetCatalogInfoResponse
        return model(**response).response
    ...
    async def get_invites(
		...
		**kwargs
        ...
        model = groups.GetInvitesResponse
        return model(**response).response
    ...
    async def set_user_note(
        self, group_id: int, user_id: int, note: Optional[str] = None, **kwargs
    ...
    async def tag_add(
        self, group_id: int, tag_name: str, tag_color: Optional[str] = None, **kwargs
    ) -> base.BoolResponseModel:
        """Add new group's tag
		:param group_id: 
		:param tag_name: 
