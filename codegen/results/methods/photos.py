...
class PhotosCategory(BaseCategory):
    ...
    async def get_comments(
		...
		**kwargs
        ...
        model = photos.GetCommentsResponse
        return model(**response).response
    ...
    async def get_user_photos(
		...
		**kwargs
        ...
        model = photos.GetUserPhotosResponse
        return model(**response).response
