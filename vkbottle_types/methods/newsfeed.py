...
class NewsfeedCategory(BaseCategory):
    ...
    async def get_lists(
        self, list_ids: Optional[List[int]] = None, extended: Optional[bool] = None
    ...
    async def unignore_item(
        self, type: str, owner_id: int, item_id: int, track_code: Optional[str] = None
    ) -> base.OkResponseModel:
    ...
    async def unsubscribe(
        self, type: str, item_id: int, owner_id: Optional[int] = None
    ) -> base.OkResponseModel:
